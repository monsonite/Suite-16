...
unsigned int M[MEMSIZE] = {
   ...
   // 0x0000 --------------------------------------------------------------------- 
    ...
    //  R4 = temporary storage for accumulator (decimated value)
     ...
     // 0x0030 ---------------------------------------------------------    
        ...
        // Accepts a hexadecimal number up to FFFF from terminal and puts it into register R0
        ...
        // R7 is used to accumulate the powers of 16 when forming the decimal integer in R0
       ...
       // 0x0040--------------------------------------------------------------------------------------
        ...
        0x0253,     // BLT 0x53 Quit  No - so must be a space or newline etc

        0x0A30,     // ADI 30   Restore R0   
        0x0B47,     // SBI 0x47  is it bigger than 0x47 ascii for "F" ?
        0x0353,     // BGT  0x53 Quit Not a hexadecimal digit 
        0x0858,     // CALL 0x0058 Test and Modify R0
   ...
   // 0x0050--------------------------------------------------------------------------------------  
        ...
        0x0B37,     // Subtract 0x37 Is it bigger than 0x37? If not subtract 0x30
        0x025C,     // BLT Not a hex decimal digit  A-F so subtract 30 and return   
        0x005E,     // BRA  Return
